...
public class WebManager {
	 ...
	 * @param login
	 */
	public static void uploadBackup(String pathfromFTProot, String homeUrl, String dBHost, String dBName, String dBPw, String dBLogin, FTPLoginInformation login){
		...
		try{
			...
			target.connect();
			target.login();
			target.uploadFolder("backup/tmp", pathfromFTProot);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void downloadtoWorkOffline(String pathfromFTProot, String remote_dbPw, String remote_dbUser, String remote_homeURL, String xammp_path, String lcl_homeUrl, String lcl_dBHost, String lcl_dBName, String lcl_dBPw, String lcl_dBLogin, String lcl_url ){
		WebManager wmanager = getWebManager();
		wmanager.backupCMS(remote_dbUser, remote_dbPw,"http://"+remote_homeURL+"/services/backup/",new OfflineModDownloadListener(xammp_path, pathfromFTProot, lcl_homeUrl, lcl_dBHost, lcl_dBName, lcl_dBPw, lcl_dBLogin, lcl_url, login));
	}
	...
	public static void uploadOfflineMode(String pathfromFTProot, String remote_dbPw, String remote_dbUser, String remote_homeURL, String xammp_path, String lcl_homeUrl, String lcl_dBHost, String lcl_dBName, String lcl_dBPw, String lcl_dBLogin, String lcl_url ){
		...
		//wmanager.installCMS(homeUrl,dBHost, dBName, dBPw, dBLogin, homeUrl+"/services/installation/",new BackupUpLoadListener());
		wmanager.backupCMS(lcl_dBPw, lcl_dBLogin, lcl_homeUrl+lcl_url, new OfflineModUploadListener(xammp_path, pathfromFTProot, lcl_homeUrl, lcl_dBHost, lcl_dBName, lcl_dBPw, lcl_dBLogin, lcl_url, login));
	}
