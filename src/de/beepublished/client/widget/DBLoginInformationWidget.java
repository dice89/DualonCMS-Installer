...
public class DBLoginInformationWidget extends Composite {
	...
	public DBLoginInformationWidget(Composite parent, int style) {
		...
		grpDbLoginInformation.setFont(BeePublishedClient.fontStandard);
		...
		lblDatenbankname.setFont(BeePublishedClient.fontStandard);
		...
		lblDatenbankname_1.setFont(BeePublishedClient.fontStandard);
		...
		inputName.setFont(BeePublishedClient.fontStandard);
		
		Label lblUser = new Label(grpDbLoginInformation, SWT.NONE);
		lblUser.setText("User");
		lblUser.setFont(BeePublishedClient.fontStandard);
		...
		inputUser.setFont(BeePublishedClient.fontStandard);
		
		Label lblPasswort = new Label(grpDbLoginInformation, SWT.NONE);
		lblPasswort.setText("Password");
		lblPasswort.setFont(BeePublishedClient.fontStandard);
		...
		inputPasswort.setFont(BeePublishedClient.fontStandard);
