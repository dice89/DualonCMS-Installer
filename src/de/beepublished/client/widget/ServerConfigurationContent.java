...
public class ServerConfigurationContent extends Composite implements SelectionListener{
	...
	public ServerConfigurationContent(Composite parent, int style) {
		...
		btnCreateNew.setFont(BeePublishedClient.fontStandard);
		...
		grpGeneral.setFont(BeePublishedClient.fontStandard);
		Button btnImportSettingFile = new Button(grpGeneral, SWT.NONE);
		btnImportSettingFile.setFont(BeePublishedClient.fontStandard);
		...
		btnExportSettingFile.setFont(BeePublishedClient.fontStandard);
